...
public String getcRCLCode() {
	return cRCLCode;
}

public void setcRCLCode(String cRCLCode) {
...
public String getOpenCloseStatu() {
	return openCloseStatu;
}

public void setOpenCloseStatu(String openCloseStatu) {
	this.openCloseStatu = openCloseStatu;
}
