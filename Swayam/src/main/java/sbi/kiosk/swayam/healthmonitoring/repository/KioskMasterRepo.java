...
@Repository
public interface KioskMasterRepo  extends CrudRepository<KioskMaster,String>{
    
	List<KioskMaster> findByBranchCode(String brachCode);
...
List<KioskMaster> findByVendor(@Param("vendor")String vendor,@Param("branchcode")String branchcode);
