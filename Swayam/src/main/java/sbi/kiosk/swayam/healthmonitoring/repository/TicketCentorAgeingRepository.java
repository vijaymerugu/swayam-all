...
@Query(value = "select nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where  AGEING>24 and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_USER_KIOSK_MAPPING  WHERE PF_ID=:pfId) and STATUS_OF_COMPLAINT='Active' ", nativeQuery = true)
public int find_3_Days_GreaterThanCountCMF(@Param("pfId") String pfId);

@Query(value="SELECT nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where  KIOSK_ID in (SELECT KIOSK_ID FROM TBL_USER_KIOSK_MAPPING WHERE PF_ID=:pfId) and STATUS_OF_COMPLAINT='Active' ", nativeQuery=true)
public int findTotalCountCMF(@Param("pfId") String pfId);
...
countQuery="select count(*) from TBL_TICKET_CENTRE where  AGEING>24  AND KIOSK_ID IN (SELECT KIOSK_ID FROM TBL_USER_KIOSK_MAPPING WHERE PF_ID=:pfId) and STATUS_OF_COMPLAINT='Active' ORDER BY call_log_date DESC ")
public Page<TicketCentor> findAllTicketCentor3DaysGreaterAndCMFUser(@Param("pfId") String pfId,Pageable pageable);
...
countQuery=" SELECT count(*) from TBL_TICKET_CENTRE where KIOSK_ID IN (SELECT KIOSK_ID FROM TBL_USER_KIOSK_MAPPING WHERE PF_ID=:pfId) and STATUS_OF_COMPLAINT='Active' ORDER BY call_log_date DESC")
...
@Query(value = " SELECT nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where  AGEING<=4  and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_KIOSK_MASTER WHERE CIRCLE=:circle) and STATUS_OF_COMPLAINT='Active' ", nativeQuery = true)
public int find2_4HoursCount(@Param("circle") String circle) ;

@Query(value=" SELECT nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where  (AGEING>4 and AGEING<=8) 	 and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_KIOSK_MASTER WHERE CIRCLE=:circle) and STATUS_OF_COMPLAINT='Active' ",nativeQuery=true)
public int find_1_DaysCount(@Param("circle") String circle);

@Query(value=" SELECT nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where   (AGEING>8 and AGEING<=24)	and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_KIOSK_MASTER WHERE CIRCLE=:circle)  and STATUS_OF_COMPLAINT='Active' ",nativeQuery=true)
public int find_3_Days_LessCount(@Param("circle") String circle);
...
@Query(value = " SELECT * from TBL_TICKET_CENTRE where  AGEING>24 and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_KIOSK_MASTER WHERE CIRCLE=:circle) and STATUS_OF_COMPLAINT='Active' ORDER BY call_log_date DESC  ", 
countQuery=" SELECT count(*) from TBL_TICKET_CENTRE where  AGEING>24 and KIOSK_ID in (SELECT KIOSK_ID FROM TBL_KIOSK_MASTER WHERE CIRCLE=:circle) and STATUS_OF_COMPLAINT='Active' ORDER BY call_log_date DESC  ",
nativeQuery = true)
public Page<TicketCentor> findAllTicketCentor3DaysGreaterByCircle(@Param("circle") String circle,Pageable pageable);
...
,countQuery=" SELECT count(*) from TBL_TICKET_CENTRE where  AGEING>24 AND KIOSK_ID IN (SELECT KIOSK_ID FROM TBL_USER_KIOSK_MAPPING WHERE PF_ID in (:pfId))  and STATUS_OF_COMPLAINT='Active' ORDER BY call_log_date DESC "
		)
public Page<TicketCentor> findAllTicketCentor3DaysGreaterAndCMSUser(@Param("pfId") Set<String> pfId,Pageable pageable);
...
//CC User
// CC
@Query(value = " select nvl(count(CALL_SUBCATEGORY),0) from TBL_TICKET_CENTRE where AGEING<=4 and STATUS_OF_COMPLAINT='Active' " , nativeQuery = true)
public int find2_4HoursCount();
...
@Query(value=" SELECT  nvl(count(CALL_SUBCATEGORY),0)  from TBL_TICKET_CENTRE where   AGEING>24  and STATUS_OF_COMPLAINT='Active' ",nativeQuery=true)
public int find_3_Days_GreaterThanCount();
