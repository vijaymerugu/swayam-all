...
public interface DowntimeService  extends IOperations<DownTimeDto>{
	...
	Page<DownTimeDto> findAllPaginated(int size, int page, String type, String selectedCircelId, String selectedVendorId, String selectedCmsCmfId, String selectedFromDateId, String selectedToDateId);
