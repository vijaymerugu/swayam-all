...
public class BillingPenaltyController {
	...
	@RequestMapping(value = "ic/UpdateCorrection",params = { "Corrections", "remarks" ,"rpfRefNumber", "kioskSerialNumber", "kisokId"}, method = RequestMethod.GET)
	public ResponseEntity<?> updateCorrections(@RequestParam("Corrections")double Corrections,@RequestParam("remarks") String remarks
		...
		int status = invoiceCorrectionRepository.
				updateInvoiceCorrection(Corrections, kisokId, kioskSerialNumber,remarks);
