...
public interface InvoiceSummaryRepository extends PagingAndSortingRepository<InvoiceSummaryEntity, String> {
	...
	@Query(value = 
			...
			"    BM.CRCL_NAME,\r\n" + 
			"    BM.STAT_DESC,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q1',AMC_COST,0) ) AS Q1_AMC_COST,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q2',AMC_COST,0) ) AS Q2_AMC_COST,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q3',AMC_COST,0) ) AS Q3_AMC_COST,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q4',AMC_COST,0) ) AS Q4_AMC_COST,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q1',(PENALTY_AMT-CORRECTION_AMT),0) ) AS Q1_PENALTY_AMT,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q2',(PENALTY_AMT-CORRECTION_AMT),0) ) AS Q2_PENALTY_AMT,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q3',(PENALTY_AMT-CORRECTION_AMT),0) ) AS Q3_PENALTY_AMT,\r\n" + 
			"    SUM(DECODE(QTR_ID,'Q4',(PENALTY_AMT-CORRECTION_AMT),0) ) AS Q4_PENALTY_AMT,\r\n" + 
	...
	@Query(value = 
			...
			countQuery="SELECT count(KM.BRANCH_CODE)/4 " +
					...
					"Where \r\n" + 
					"    INV.FIN_YR=:quterTimePeriod ")
	Page<InvoiceSummaryEntity> findCCFilter(
			@Param("quterTimePeriod") String quterTimePeriod,Pageable pageable);
	...
	@Query(value = 
			...
			"    BM.CRCL_NAME,\r\n" + 
			"    BM.STAT_DESC",nativeQuery = true)
	List<InvoiceSummaryEntity> findCCFilterReport(
			@Param("quterTimePeriod") String quterTimePeriod);
