...
public interface InvoiceCompareRepository extends PagingAndSortingRepository<InvoiceCompare, String>{
	...
	@Query(value = "select s1.RFP_REF_NO,s1.VENDOR,  s2.CRCL_NAME, s2.STAT_DESC, s3.KIOSK_ID, s3.KIOSK_SERIAL_NO,s3.QTR_ID,s3.FIN_YR,s3.INVOICE_AMT,s5.INVO_AMT,ABS(s3.INVOICE_AMT - s5.INVO_AMT) as DIFFERENCE \r\n" + 
			"from TBL_INVOICE s3\r\n" + 
