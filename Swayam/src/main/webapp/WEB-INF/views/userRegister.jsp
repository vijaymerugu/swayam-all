...
<div id="page-wrapper">
 ...
 <font  size="2" color="red"> <b><div id="txtHint"></div></b></font> 
	...
	<form:form role="form"  class="form-horizontal" id="usersBean" name="usersBean" action="saveEditUserMaster" method="post"  modelAttribute="usersBean"  autocomplete="off"> 
            ...
            <div class="form-group required">
              ...
              <!----------------------------  <div> end ---------------------------------------->
				...
				<div class="col-sm-12">
					<c:if test="${usersBean.checkAction == 'Edit'}">				 
						<input type="submit" name="Submit" value="Update" class="btn btn-pink pull-right" style="margin-right: 10px">
						<input type="reset" name="Submit"  value="Reset" class="btn btn-pink pull-right" style="margin-right: 10px">
					</c:if>
					<c:if test="${usersBean.checkAction != 'Edit'}">
						<input type="submit" name="Submit"   value="Save" class="btn btn-pink pull-right" style="margin-right: 10px" > 
						<input type="reset" name="Submit"  value="Reset" class="btn btn-pink pull-right" style="margin-right: 10px"> 
					</c:if> 
				</div>
              </div>
