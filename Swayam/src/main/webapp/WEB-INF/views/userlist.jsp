...
<br/>
	...
	<input ng-model="searchText" placeholder="Enter Username, First Name, Last Name, Mail Id etc." style="font-size: 12px" "cursor: hand;cursor: pointer;" size="150" height="80"   class="form-group has-search" id="input">
