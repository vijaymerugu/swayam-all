...
<script src="resources/js/rfp-details-BC.js"></script>
<script	src="resources/js/angular.1.5.6.min.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                         <div class="text-right" style="width: 80%;" >
                             <button  id="btnReset" ng-click="" style="cursor: hand;cursor: pointer;background: #dddddd"  disabled>Reset</button>							
					...
					selectedAMCcost,selectedCPenalty,selectedDMU,selectedDMUR,selectedDCT,selectedMP)">Add</button> -->
							  <button type="submit" id="submit" style="cursor: hand;cursor: pointer;background: #dddddd" disabled>Add</button>
                         </div>
                    </div>
                </div>
			</td>
