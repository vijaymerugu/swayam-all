...
<script src="resources/js/daCumulativeDataCC.js"></script>
	...
	<div class="main" ng-app="daCumulativeDataCCModule" id="appId">
		...
		<div class="absolute">
			...
			<div class="submain" align="center">
				<h5 style="font-weight: bold;" align="center">Cumulative Data</h5>
				<table>
					<tr>
					<td>
							<div class="rcorners">
								...
								<div>
									<table align="center">
										...
										<tr ng-repeat="item in apiResponse1" ng-if="item.circleName != null">
											<td align="left">{{item.circleName}}</td>
											<td align="right">{{item.totalOperationalKiosks}}</td>
											<td align="right">{{item.totalKiosks}}</td>
											<td align="right">{{item.availableKiosksPercent}}</td>
										</tr>
										<tr>
											<td align="left"><b>{{apiTotal[apiTotal.length-1].gtLabel}}</b></td>
											<td align="right"><b>{{apiTotal[apiTotal.length-1].gtOperationalKiosks}}</b></td>
											<td align="right"><b>{{apiTotal[apiTotal.length-1].gtTotalKiosks}}</b></td>
											<td align="right"><b>{{apiTotal[apiTotal.length-1].gtAvailabilityPercent | number: 2}}</b></td>
										</tr>
									</table>
								</div>
							</div>
								...
								<div id="chartDiv">
								 ...
								 <div >
									<table align="center">
										...
										<tr ng-repeat="num in apiResponse5" ng-if="num.circleName != null">
