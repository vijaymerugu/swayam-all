...
<script src="resources/js/requests-circle-app.js"></script>
...
<script type="text/javascript">
	function cloesBox() {
	 ...
	 var window;
		function openWin(){
		      window.location.href = "hm/requestFormGridCircle";
		};
...
$(document).ready(function(){
    $('.openFinalPopup').on('click',function(){      
    	...
    	$("#contentHomeApp").load('hm/requestFormGridCircle');    	
