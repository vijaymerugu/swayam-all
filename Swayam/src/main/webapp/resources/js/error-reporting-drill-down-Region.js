...
app.controller('ErrorReportDrillDownCtrl', ['$scope','$filter','ErrorReportDrillDownService','uiGridConstants', function ($scope, $filter,ErrorReportDrillDownService,uiGridConstants) {
   ...
   $scope.loadHomeBodyPageForms = function(regionName){	   
		if(circleName != undefined || networkName != undefined || moduleName != undefined || regionName != undefined){	
			var str ='td/errorDrillDownBranch?circleName='+circleName+'&networkName='+networkName+'&moduleName='+moduleName+'&regionName='+regionName+'&fromDate='+fromDate+'&toDate='+toDate;
			$("#contentHomeApp").load(str);
		}						
	}
	
	
	 $scope.loadHomeBodyPageForms2 = function(regionName){	   
		if(regionName != undefined){	
			
			var str ='td/errorSummaryDrillDownNoOfBussinesFailRegionName?regionName='+regionName+'&fromDate='+fromDate+'&toDate='+toDate;
			$("#contentHomeApp").load(str);
		}						
	}
	
	 $scope.loadHomeBodyPageForms1 = function(regionName){	   
		if(regionName != undefined){	
			
			var str ='td/errorSummaryDrillDownNoOfTechFailRegionName?regionName='+regionName+'&fromDate='+fromDate+'&toDate='+toDate;
			$("#contentHomeApp").load(str);
		}						
	}
 ...
 $scope.backUser = function()
   {  	
	     ...
	     //   alert("i m inside backUser");
	        regionName = "";
	        var str ='td/errorDrillDownRegionBack?circleName='+circleName+'&networkName='+networkName+'&moduleName='+moduleName+'&regionName='+regionName+'&fromDate='+fromDate+'&toDate='+toDate;
			$("#contentHomeApp").load(str);
			$("#loading").hide();  
