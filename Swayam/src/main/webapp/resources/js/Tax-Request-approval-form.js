	...
	app.service('approveService',['$http', function ($http) {
		...
		*/
		...
		function approve(reqId,selectedcommnets,csrf) {
	        ...
	        return  $http({
	          method: 'GET',
	          url: 'approveTaxDetails/get?reqId='+reqId+'&commnets='+selectedcommnets,
	          headers: 
              {
                  'X-CSRF-TOKEN': csrf
              }
		...
		function reject(reqId,selectedcommnets,csrf) {
		        ...
		        return  $http({
		          method: 'GET',
		          url: 'rejectTaxDetails/get?reqId='+reqId+'&commnets='+selectedcommnets,
		          headers: 
	              {
	                  'X-CSRF-TOKEN': csrf
	              }
		...
		function updateMakersComments(reqId,selectedcommnets,csrf) {
	        ...
	        return  $http({
	          method: 'GET',
	          url: 'updateTaxComment/get?reqId='+reqId+'&commnets='+selectedcommnets,
	          headers: 
              {
                  'X-CSRF-TOKEN': csrf
              }
